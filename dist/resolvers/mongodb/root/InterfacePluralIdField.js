...
exports.InterfacePluralIdField = InterfacePluralIdField;
...
function InterfacePluralIdField(_ref) {
  var schema = _ref.schema;
  var name = _ref.name;

  var inter = schema[name];
  (0, _jsutilsInvariant2['default'])(inter && inter.kind === 'interface', 'interface must be passed to resolver');
      ...
      while (1) switch (context$2$0.prev = context$2$0.next) {
        ...
        case 6:
          idMap = args.id.reduce(function (acc, id) {
            return inter.implementations.includes((0, _jsutilsGlobalId.typeFromGlobalId)(id)) ? _extends({}, acc, _defineProperty({}, (0, _jsutilsGlobalId.typeFromGlobalId)(id), (acc[(0, _jsutilsGlobalId.typeFromGlobalId)(id)] || []).concat(id))) : acc;
          }, {});
