...
function readToken(source, fromPosition) {
  ...
  throw (0, _syntaxError.syntaxError)(source, position, 'Unexpected character "' + fromCharCode(code) + '".');
}
...
function readNumber(source, start, firstCode) {
  ...
  if (code === 48) {
    ...
    code = charCodeAt.call(body, ++position);
    if (code >= 48 && code <= 57) {
      throw (0, _syntaxError.syntaxError)(source, position, 'Invalid number, unexpected digit after 0: "' + fromCharCode(code) + '".');
    }
  } else {
...
function readDigits(source, start, firstCode) {
  ...
  throw (0, _syntaxError.syntaxError)(source, position, 'Invalid number, expected digit but got: ' + (code ? '"' + fromCharCode(code) + '"' : 'EOF') + '.');
}
    ...
    if (code === 92) {
      ...
      switch (code) {
        ...
        case 117:
          ...
          if (charCode < 0) {
            throw (0, _syntaxError.syntaxError)(source, position, 'Bad character escape sequence.');
          }
